...
[linalg]: https://docs.rs/ndarray-linalg
...
[ndarray for NumPy users](https://docs.rs/ndarray/0.15.3/ndarray/doc/ndarray_for_numpy_users/index.html) にNumPyから移行向けの資料があります。
